...
export const strategyDigitaleRoadmapMetadata: TriarcPageMetadata = {
  title: 'Digitale Roadmap & Priorisierung – triarc laboratories',
  metaTitle: 'Digitale Roadmap & IT-Priorisierung für KMU | triarc labs',
  description:
    'Von der IST-Analyse zur umsetzbaren Digitalisierungs-Roadmap: Prioritäten, Abhängigkeiten und Business Case – damit Investitionen in Software und Prozesse wirken.',
}

export const strategyMenschenOrganisationMetadata: TriarcPageMetadata = {
  title: 'Menschen, Organisation & Veränderung – triarc laboratories',
  metaTitle: 'Change Management & Digitalisierung mittragend gestalten | triarc labs',
  description:
    'Digitalisierung braucht klare Ziele und tragfähige Organisation: Führung, Kommunikation und Prozesse so ausrichten, dass Teams neue Lösungen nachhaltig nutzen.',
}

export const operationsFeldLogistikMetadata: TriarcPageMetadata = {
  title: 'Feld, Service & Logistik digital – triarc laboratories',
  metaTitle: 'Mobile Logistik, Dispo & Rapportierung | triarc labs',
  description:
    'Digitale Abläufe für Aussendienst, Lager und Disposition: mobile Apps, ERP-Anbindung und weniger Papier – mit Referenzen aus Logistik, Chemie und Bau.',
}

export const operationsDatenIntegrationMetadata: TriarcPageMetadata = {
  title: 'Daten, ERP & Integration – triarc laboratories',
  metaTitle: 'ERP-Integration, Datenqualität & μLink | triarc labs',
  description:
    'Konsistente Daten zwischen ABACUS, Fachsoftware und Mobile Apps. Integration massgeschneidert oder über μLink – weniger manuelle Schnittstellen, mehr Transparenz.',
}

export const futureSkalierungPlattformenMetadata: TriarcPageMetadata = {
  title: 'Skalierung & Plattformen – triarc laboratories',
  metaTitle: 'Skalierbare Software & Plattformstrategie | triarc labs',
  description:
    'Wachstum ohne technische Sackgassen: modulare Plattformen, klare Zuständigkeiten und erweiterbare Architektur – von Work Management bis Multi-Channel.',
}

export const futureInnovationDaueraufgabeMetadata: TriarcPageMetadata = {
  title: 'Innovation als Daueraufgabe – triarc laboratories',
  metaTitle: 'KI, MVPs & kontinuierliche Innovation | triarc labs',
  description:
    'Innovation strukturiert betreiben: Voice Reporting mit KI, Prototyping, MVPs und das Innovation Lab – neue Technologien erproben und produktiv nutzen.',
}
